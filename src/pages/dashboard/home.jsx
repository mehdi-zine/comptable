        ...
        <Card className="overflow-y-scroll overflow-hidden xl:col-span-2 border border-blue-gray-100 shadow-sm">
          ...
          <CardBody className=" max-h-[400px] px-0 pt-0 pb-2">
            <table className="w-full min-w-[640px] table-auto">
              ...
              <tbody>
                {clientsData.map(
                  ({id, image, nom, email, telephone, adresse}, key) => {
                      ...
                      <tr key={nom}>
                        <td className={className}>
                          <div className="flex items-center gap-4">
                            <Avatar src={image || placeHolderImage} alt={nom} size="md" />
                            <Typography
                              variant="small"
                              color="blue-gray"
                              className="font-bold"
                        ...
                        <td className={className}>
                          ...
                          >
                            <Link
                              ...
                              state={{id: id, image: image, nom: nom,  email: email, telephone: telephone, adresse: adresse}}>
